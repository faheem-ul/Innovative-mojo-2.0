      ...
      <div className="w-full h-full flex justify-center items-center">
        <div className="w-full max-w-[1236px]">
          ...
          <div className="flex justify-between flex-wrap navsize:justify-center navsize:gap-[50px]">
            <div className="border border-gold rounded-[13px] max-w-[289px] py-[30px] px-[25px] mob:max-w-full">
            ...
            {/* 3 */}
            <div className="border border-gold rounded-[13px] max-w-[289px] py-[30px] px-[20px] mob:max-w-full">
              <Text className="text-[25px] text-center font-semibold mb-[14px] h-[56px] flex justify-center items-center">
                Tailored Approach
              </Text>
              <Text className="text-[14px] text-center">
            ...
            {/* 4 */}
            <div className="border border-gold rounded-[13px] max-w-[289px] py-[30px] px-[5px] mob:px-5 mob:max-w-full">
              <Text className="text-[25px] text-center font-semibold mb-[14px] h-[56px] flex justify-center items-center">
                Versatility
              </Text>
              <Text className="text-[14px] text-center">
