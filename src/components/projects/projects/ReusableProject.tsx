...
const ReusableProject: React.FC<props> = ({
  ...
  return (
    <div className="relative group overflow-hidden rounded-lg">
      ...
      <div className="absolute inset-0 project-overlay rounded-[40px] flex items-end justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-700">
